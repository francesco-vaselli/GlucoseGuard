...
def build_model(model_config, model_name):
    if model_name == "cnn":
...
def train(
    ...
    model = build_model(model_config, model_name)
    if optimizer == "adam":
